...
public enum Hook
{
    RECOLOUR(Class.MINECHEM_HOOKS, "recolourAdvancement", "(Lnet/minecraft/stats/Advancement;F)V"),
    RESET(Class.MINECHEM_HOOKS, "resetGreyscale", "(F)V"),
    ICON(Class.MINECHEM_HOOKS, "drawIconAdvancement", "(Lnet/minecraft/client/renderer/entity/RenderItem;Lnet/minecraft/client/gui/FontRenderer;Lnet/minecraft/client/renderer/texture/TextureManager;Lnet/minecraft/item/ItemStack;IILnet/minecraft/stats/Advancement;)V"),
    BACKGROUND(Class.MINECHEM_HOOKS, "drawAdvancementListBackground", "(Lnet/minecraft/client/Minecraft;FIII)V"),
